            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><router-link to="#">Update Category Form</router-link>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" @submit.prevent="editCategory" enctype="multipart/form-data">
                                <div class="form-body">
                                    <div class="row">
