            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><router-link to="#">Add New Customer Form</router-link>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" @submit.prevent="customerInsert" enctype="multipart/form-data">
                                <div class="form-body">
                                    <div class="row">
