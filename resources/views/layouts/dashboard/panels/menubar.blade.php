    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><router-link class="navbar-brand" :to="{name: 'dashboard'}">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="User">Employee</span></a>
                    <ul class="menu-content">
                        <li>
                            <router-link :to="{name: 'store-employee'}"><i class="feather icon-plus-circle"></i><span class="menu-item" data-i18n="Add">Add Employee</span>
                            </router-link>
                        </li>
                        <li>
                            <router-link :to="{name: 'index-employee'}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="Details">All Employee</span>
                            </router-link>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item"><a href="#"><i class="feather icon-codepen"></i><span class="menu-title" data-i18n="Supplier">Supplier</span></a>
                    <ul class="menu-content">
                        ...
                        <li>
                            <router-link :to="{name: 'index-supplier'}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="Details">All Supplier</span>
                            </router-link>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item"><a href="#"><i class="feather icon-credit-card"></i><span class="menu-title" data-i18n="Expense">Expense</span></a>
                    <ul class="menu-content">
                        <li>
                            <router-link :to="{name: 'store-expense'}"><i class="feather icon-plus-circle"></i><span class="menu-item" data-i18n="Add">Add Expense</span>
                            </router-link>
                        </li>
                        <li>
                            <router-link :to="{name: 'index-expense'}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="Details">All Expense</span>
                            </router-link>
                        </li>
                    </ul>
                </li>
                ...
                {{-- Stock Menu Start --}}
                <li class=" nav-item">
                    <router-link :to="{name: 'stock'}"><i class="feather icon-truck"></i><span class="menu-title" data-i18n="Stock">Stock</span></router-link>
                </li>
                {{-- Stock Menu End --}}
                {{--   Customer Menu Start --}}
                <li class="nav-item"><a href="#"><i class="feather icon-users"></i><span class="menu-title" data-i18n="Customer">Customer</span></a>
                    <ul class="menu-content">
                        <li>
                            <router-link :to="{name: 'store-customer'}"><i class="feather icon-user-plus"></i><span class="menu-item" data-i18n="Add">Add Customer</span>
                            </router-link>
                        </li>
                        <li>
                            <router-link :to="{name: 'index-customer'}"><i class="feather icon-user-check"></i><span class="menu-item" data-i18n="Details">All Customer</span>
                            </router-link>
                        </li>
                    </ul>
                </li>
